@echo off
title Location Tracker - USER PANEL
color 0B
cls

echo.
echo ========================================================
echo   Location Tracker - USER PANEL LAUNCHER
echo ========================================================
echo.
...
REM Step 2: Use User app flavor
echo [2/6] Preparing User app flavor...
adb shell am force-stop com.locationtracker.user >nul 2>&1
adb shell pm clear com.locationtracker.user >nul 2>&1
...
call npx react-native run-android --mode userDebug --appId com.locationtracker.user --no-packager
...
echo.
echo ========================================================
echo   USER PANEL is now running!
echo ========================================================
echo.
